        ...
        <div class="error">
            <div class="container-floud">
                <div class="col-xs-12 ground-color text-center">
                    ...
                    <h2 class="h1">Sorry! Not have access</h2>
                    <button type="button" class="btn btn-info btn-flat margin btn-lg" onclick="window.history.back()"><i class="fa fa-fw fa-hand-o-left"></i>Go to back</button>
                </div>
            </div>
        </div>
        <!-- Error Page -->
