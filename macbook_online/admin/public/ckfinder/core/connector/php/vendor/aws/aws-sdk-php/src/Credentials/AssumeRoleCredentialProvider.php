...
/**
 * Credential provider that provides credentials via assuming a permissions
...
class AssumeRoleCredentialProvider
{
    ...
    /**
     * Loads assume permissions credentials.
     *
        ...
        return $client->assumeRoleAsync($this->assumeRoleParams)
            ->then(function (Result $result) {
                ...
                throw new CredentialsException(
                    "Error in retrieving assume permissions credentials.",
                    0,
                    $exception
                );
            });
