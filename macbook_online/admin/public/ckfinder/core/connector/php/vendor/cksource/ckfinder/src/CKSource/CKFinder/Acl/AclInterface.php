...
interface AclInterface
{
     ...
     * @param string $role         the user permissions name (also `*` for all roles)
     *
     * @return Acl $this
     *
     * @see Permission
    ...
    /**
     * Checks if a permissions has the required permission for a folder.
     *
     * @param string $resourceType the resource type identifier (also `*` for all resource types)
     * @param string $folderPath   the folder path
     * @param int    $permission   the permission numeric value
     * @param string $role         the user permissions name (also `*` for all roles)
     *
     * @return bool true if permissions has required permission
     *
     * @see Permission
     */
    ...
    /**
     * Computes a mask based on the current user permissions and ACL rules.
     *
     * @param string $resourceType the resource type identifier (also `*` for all resource types)
     * @param string $folderPath   the folder path
     * @param string $role         the user permissions name (also `*` for all roles)
