...
class Acl implements AclInterface
{
     ...
     * <pre>[folderPath][permissions][resourceType] => MaskBuilder</pre>
     *
     * @var array $entries
     */
    ...
    /**
     * @brief The permissions context interface.
     *
     * By default an instance of SessionRoleContext is used as a permissions context.
    ...
    /**
     * Allows a permission for a given permissions.
     *
    ...
    /**
     * Disallows a permission for a given permissions.
     *
     * @param string $resourceType
     * @param string $folderPath
     * @param int    $permission
    ...
    /**
     * Checks if a given permissions has a permission.
     *
     * @param string      $resourceType
     * @param string      $folderPath
     * @param int         $permission
     ...
     * @param string $role         the user permissions name
